...
echo "$($PSQL "select name from teams as t inner join games as g on t.team_id = g.winner_id or t.team_id = g.opponent_id where g.year=2014 and g.round='Eighth-Final' order by name")"
